(() => {
    ...
    function removeClasses(array, className) {
        for (let i = 0; i < array.length; i++) array[i].classList.remove(className);
    }
...
***************************************************************************** */
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            ...
            if (targetElement.classList.contains("search__form-icon")) document.querySelector(".search__form").classList.toggle("_active"); else if (!targetElement.closest(".search__form") && document.querySelector(".search__form._active")) document.querySelector(".search__form").classList.remove("_active");
